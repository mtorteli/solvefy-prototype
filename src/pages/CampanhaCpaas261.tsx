    ...
    <div className="cpaas261">
      ...
      <section id="form" className="c261-form">
        <div className="c261-form__in">
          ...
          <div className="c261-form__card rv">
            <ul className="c261-form__list">
              <li><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg> R$0,06 por SMS travado no seu volume</li>
              <li><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg> 40% mais barato que o mercado, sem mensalidade</li>
              <li><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg> Tarifa mantida depois da Copa, no volume contratado</li>
            </ul>
            <a href={FORM_URL} target="_blank" rel="noopener noreferrer" className="c261-btn">
              Travar meu R$0,06 <Arrow />
            </a>
            <p className="c261-form__fine">Ao enviar, você concorda com os termos da campanha. Válido para recargas a partir de R$1.000.</p>
          </div>
        </div>
      </section>
