...
const CpaasWhatsapp = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <SEO
        title={t("whatsapp.metaTitle")}
        description={t("whatsapp.metaDescription")}
        ...
        schemas={[
          breadcrumbSchema(
            [
              ...
              { name: t("whatsapp.breadcrumbSelf"), path: "/cpaas/whatsapp" },
            ],
            locale,
          ),
        ]}
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <h1 className="tracking-tight leading-tight text-balance">
              ...
              <span className="text-[hsl(var(--cpaas))]">
                {t("whatsapp.soonHighlight")}
              </span>
            </h1>
            <p className="section-subtitle mt-4">
              {t("common.soonBody", { channel: t("whatsapp.channelName") })}
            </p>
          </div>
        </section>
      </main>
